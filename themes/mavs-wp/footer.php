    ...
    <div class="footer__wrapper">
      <nav class="fnav">
        <ul class="fnav__nav">
          ...
          <li class="fnav__list"><a href="<?php echo esc_url(home_url('/')); ?>blog.html/" class="fnav__link">BLOG</a></li>
          <li class="fnav__list"><a href="#" class="fnav__link">NEWS</a></li>
        </ul>
      </nav>
      <div class="footer__container">
        <div class="footer__box">
          <div class="footer__btn"><a href="<?php echo esc_url(home_url('/')); ?>contact.html/" class="footer__btnLink">CONTACT</a></div>
